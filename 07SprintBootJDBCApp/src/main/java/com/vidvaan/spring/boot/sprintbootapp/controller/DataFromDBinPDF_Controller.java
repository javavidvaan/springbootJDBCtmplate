...
public class DataFromDBinPDF_Controller {
	public static void main(String[] args) throws Exception{
        ...
        ResultSet query_set = stmt.executeQuery("SELECT * FROM EMPL WHERE ENO=16");
        /* Step-2: Initialize PDF documents - logical objects */
        Document my_pdf_report = new Document();
        
        
        
        PdfWriter.getInstance(my_pdf_report, new FileOutputStream("pdf_find_by_id.pdf"));
        my_pdf_report.open();            
